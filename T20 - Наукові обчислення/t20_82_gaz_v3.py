...
#Програти відео у уповільненому режимі
...
speed = 1 / int(input('Коефіцієнт уповільнення відео:'))
#програти відео
os.system("mplayer -speed {} anim.mpg".format(speed))

os.system("del anim.mpg")   #видалення файлу відео
